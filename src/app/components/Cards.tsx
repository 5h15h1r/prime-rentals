  ...
  return (
    <>
      <Link href={`/details/${item.slug}`}>
        <div className="relative max-w-sm overflow-hidden rounded-lg border-2 border-blue-500 bg-white shadow">
          ...
          <div className="p-10 mt-2 md:p-5">
            <div className="mb-2">
              <h4 className="text-xl font-bold tracking-tight text-gray-900">
                {item.title}
              </h4>
              <h6 className="text-lg font-bold tracking-tight text-gray-900">
                ₹{item.price}
              </h6>
